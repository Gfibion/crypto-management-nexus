...
import { ArrowDown, Briefcase, Star } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-purple-800/30 hover:border-purple-600/50 transition-all duration-300 hover:transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-purple-300">Business Management</h3>
                <p className="text-gray-400">Strategic planning, operations optimization, and leadership excellence in modern business environments.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-purple-800/30 hover:border-purple-600/50 transition-all duration-300 hover:transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-purple-300">ICT Proficiency</h3>
                <p className="text-gray-400">Advanced technology integration, digital transformation, and innovative IT solutions for business growth.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-800/50 border-purple-800/30 hover:border-purple-600/50 transition-all duration-300 hover:transform hover:scale-105">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-purple-300">Blockchain Enthusiasm</h3>
                <p className="text-gray-400">Crypto advisory, Web3 integration, and blockchain strategy for future-ready businesses.</p>
              </CardContent>
            </Card>
          </div>
        </div>
